...
import { Package, ArrowLeft, Plus, Sprout, Search, PlusCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full relative z-10">
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">Manage your farm produce and inventory batches.</p>
          </div>
        </div>
      ...
      {state.products.length > 0 ? (
        ...
        <div className="py-16 px-6 text-center border border-dashed border-slate-800 rounded-3xl bg-slate-900/30 max-w-2xl mx-auto space-y-4">
          ...
          <h2 className="text-xl font-bold text-white">No products added yet</h2>
          <p className="text-sm text-slate-400 max-w-md mx-auto">
            Add your first product to start reaching commercial buyers, Mandi traders, and receiving micro-logistics pickup services.
          </p>
          <div className="pt-2">
            <button
              onClick={() => navigate('/farmer/products/new')}
              className="px-6 py-3 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-sm inline-flex items-center gap-2 transition-colors shadow-lg shadow-emerald-500/20"
            >
