...
const NAV_ITEMS = [
  ...
  { label: 'Post Procurement', path: '/buyer/procurement', icon: FilePlus },
  { label: 'Orders & Tracking', path: '/buyer/orders', icon: ShoppingBag },
  { label: 'Produce Catalog', path: '/buyer/produce', icon: Store },
];
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-2 sm:py-0 gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2.5 py-1.5 sm:py-3">
              ...
              <div>
                ...
                <span className="text-[11px] text-gray-500 hidden sm:inline">Commercial Procurement & Sourcing</span>
              </div>
            </div>
