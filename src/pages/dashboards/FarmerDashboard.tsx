...
export const FarmerDashboard: React.FC = () => {
  ...
  // Derive dynamic recent activity from state without duplicates
  const dynamicActivities = [
    ...
    {
      id: 'default-payout',
      title: 'Batch #RF-8820 Payout Received',
      subtitle: '₹14,350 credited to SBI A/c • DBT Verified',
      type: 'success'
    }
  ];
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              Ramesh Kumar Patel • Satara & Pune Agro Cluster Hub
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-6">
        ...
        >
          ...
          <div className="mt-3">
            ...
            <span className="text-xs text-emerald-400 block mt-1">Recently updated</span>
          </div>
        </div>
        ...
        >
          ...
          <div className="mt-3">
            <span className="text-2xl sm:text-3xl font-extrabold text-white">{allDemandsCount} Matches</span>
            <span className="text-xs text-amber-400 block mt-1">High demand nearby</span>
          </div>
        </div>
        ...
        >
          ...
          <div className="mt-3">
            ...
            <span className="text-xs text-violet-400 block mt-1">{state.logisticsRequests.filter(r => r.status !== 'Delivered').length} In progress</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
        ...
        <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[11px] text-emerald-400 font-semibold">{allDemandsCount} Live Signals</span>
          </div>
