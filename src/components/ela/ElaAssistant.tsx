// ELA Floating Assistant Widget
// RuralFlow Multilingual Logistics Intelligence Assistant Floating Control
...
export const ElaAssistant: React.FC = () => {
      ...
      <motion.button
        ...
        className={`relative group flex items-center gap-2.5 px-4 py-3 rounded-full font-sans shadow-xl border cursor-pointer transition-all duration-300 ${
          isOpen
            ...
            : 'bg-linear-to-r from-[#1B5E20] via-[#2E7D32] to-[#388E3C] text-white border-green-400/40 shadow-green-900/30 hover:shadow-green-900/40'
        }`}
      >
